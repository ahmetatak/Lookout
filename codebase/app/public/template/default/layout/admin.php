  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <button class="btn btn-link btn-sm text-white order-1 order-sm-0" id="sidebarToggle" href="#">
        <i title="Navigation button"  name="Navigation button" class="fas fa-bars"></i>
      </button>
      ...
      <ul class="navbar-nav ml-auto ml-md-0 animated">
        ...
        <li class="nav-item dropdown no-arrow">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
            ...
            <div class="dropdown-divider"></div>
            <a title="Logout" name="Logout" class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal">Logout</a>
          </div>
        </li>
      </ul>
          ...
          <a class="nav-link" href="dashboard" data-toggle="collapse" data-target="#account">
            ...
            <i class="fas fa-caret-down float-right "></i>
              ...
              <ul class="sub-menu collapse" id="account">
                 <li><a href="#"><i class="fas fa-user "></i> All Accounts</a></li>
               <li><a href="#"><i class="fas fa-plus "></i> Add A New Account</a></li>
