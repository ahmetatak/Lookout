...
<div class="card mb-3">
  ...
  <div class="card-body">
    <form action="<?php echo URL . DS . FOLDER_ADMIN . "/vehicle/add/"; ?>" method="post">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-5">
          <input id="serial" name="serial" type="text" placeholder="Please enter vehicle serial number" class="form-control input-md" required="">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-5">
          <input id="plate" name="plate" type="text" placeholder="Please enter plate number of the vehicle" class="form-control input-md" required>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-5">
          <select id="vehicle" name="vehicle" class="form-control">
            <option selected value=""><?php echo _("Please select a type") ?></option>
        ...
        <div class="col-auto"> <i id="vehicleType" class="fas fa-car text-primary fa-2x"></i></div>
