...
class Upload {
    ...
    function upload($file, $lang = 'en_GB') {
        ...
        $this->translation['file_error']                  = _('File error. Please try again.');
        $this->translation['local_file_missing']          = _('Local file doesn\'t exist.');
        $this->translation['local_file_not_readable']     = _('Local file is not readable.');
        $this->translation['uploaded_too_big_ini']        = _('File upload error (the uploaded file exceeds the upload_max_filesize directive in php.ini).');
        $this->translation['uploaded_too_big_html']       = _('File upload error (the uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the html form).');
        $this->translation['uploaded_partial']            = _('File upload error (the uploaded file was only partially uploaded).');
        $this->translation['uploaded_missing']            = _('File upload error (no file was uploaded).');
...
//        }
    ...
    function process($server_path = null) {
        ...
        if ($this->processed) {
            $this->file_dst_path        = ROOT.DS.$server_path;
