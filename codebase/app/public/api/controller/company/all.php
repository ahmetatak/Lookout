...
class ControllerAdminCompanyAll extends Controller
{
    ...
    public function index($i = "")
    {
        ...
        if (Session::checklogin("token") == TRUE) {
            ...
            if (Session::is("admin")) {
                ...
                $this->data["companies"] = $this->model->all($this->data["start"], $limit);
        ...
        $this->call->view("company/index", _("Control Panel "), $this->data, "admin");
    }
