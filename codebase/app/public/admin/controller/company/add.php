...
class ControllerAdminCompanyAdd extends Controller
{
    private $id;
    ...
    public function index($i = "")
    {
            ...
            if (Session::is("admin")) {
                ...
                if ($this->form->check("name", "POST") and $this->form->check("phone", "POST") and $this->form->check("statu", "POST")) {
                    ...
                    if (!$this->form->submit() == TRUE) {
                        ...
                        $this->return = $this->model->insert($this->data["update"]);
                        if ($this->return) {
        ...
        $this->call->view("company/insert", _("Control Panel "), $this->data, "admin");
    }
