...
class ControllerAdminEmployeeAll extends Controller
{
    ...
    public function index($i = "")
    {
        ...
        if (Session::checklogin("token") == TRUE) {
            ...
            if (Session::is("admin")) {
                ...
                $this->data["employees"] = $this->model->all($this->data["start"], $limit);
        ...
        $this->call->view("employee/all", _("All Employees"), $this->data, "admin");
    }
