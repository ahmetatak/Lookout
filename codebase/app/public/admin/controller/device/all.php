...
class ControllerAdminDeviceAll extends Controller
{
    ...
    public function index($i = "")
    {
        ...
        if (Session::checklogin("token") == TRUE) {
            ...
            if (Session::is("admin")) {
                ...
                $this->data["devices"] = $this->model->all($this->data["start"], $limit);
        ...
        $this->call->view("device/all", _("All Devices"), $this->data, "admin");
    }

    public function e($i = "", $ii = "")
    {
        die($i);
    }
}
