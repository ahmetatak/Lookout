...
<html>
    <head>
    <title>aaa<?php echo $this->title." - ".SITE_TITLE; ?></title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <?php echo $this->css;?>
     <link rel="stylesheet" type="text/css" href="<?php echo URL."/template/".TEMPLATE ?>/css/bootstrap/bootstrap.min.css">
 
    <link rel="stylesheet" type="text/css" href="<?php echo URL."/template/".TEMPLATE ?>/css/site/admin/admin.css">
    <script src="<?php echo URL."/template/".TEMPLATE ?>/js/jquery.js" type="text/javascript" language="JavaScript"> </script>    
    <script src="<?php echo URL."/template/".TEMPLATE ?>/js/bootstrap.min.js" type="text/javascript" language="JavaScript"> </script> 
    <script src="<?php echo URL."/template/".TEMPLATE ?>/js/admin/navbar.js" type="text/javascript" language="JavaScript"> </script>    
...
<link rel="icon" href="<?php echo URL."/template/".TEMPLATE ?>/img/favicon.ico" type="image/x-icon">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <!-- Navbar -->
      <ul class="navbar-nav ml-auto ml-md-0 animated">
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        <li class="nav-item">
          ...
          <a class="nav-link" href="<?php echo URL.DS.FOLDER_ADMIN;?>/dashboard/" >
      ...
      <li class="nav-item">
          ...
          <a class="nav-link" href="dashboard" data-toggle="collapse" data-target="#company">
            <i class="fas fa-fw fa-handshake "></i>
            <span>Companies</span>
             <i class="fas fa-caret-down float-right "></i>
          </a>
              <ul class="sub-menu collapse" id="company">
                  <li><a href="<?php echo URL.DS.FOLDER_ADMIN;?>/company/all"><i class="fas fa-handshake "></i> All companies</a></li>
               <li><a href="<?php echo URL.DS.FOLDER_ADMIN;?>/company/add/"><i class="fas fa-plus "></i> Add A New Company</a></li>
            <li><a href="<?php echo URL.DS.FOLDER_ADMIN;?>/employee/add"><i class="fas fa-plus "></i> Add A New Employe</a></li>
                </ul>
        </li>
       <li class="nav-item">
     
          <a class="nav-link" href="dashboard" data-toggle="collapse" data-target="#device">
            <i class="fas fa-fw fa-microchip  "></i>
            <span>Devices </span>
          <i class="fas fa-caret-down float-right "></i>   
          </a>      
              <ul class="sub-menu collapse" id="device">
                 <li><a href="<?php echo URL.DS.FOLDER_ADMIN;?>/device/all"><i class="fas fa-hdd "></i> All Devices</a></li>
               <li><a href="<?php echo URL.DS.FOLDER_ADMIN;?>/device/add"><i class="fas fa-plus "></i> Add A New Device</a></li>
            
                </ul>
        </li>
              <li class="nav-item">
          <a class="nav-link" href="dashboard" data-toggle="collapse" data-target="#vehicle">
            <i class="fas fa-fw fa-truck-moving  "></i>
            <span>Vehicles</span>
            <i class="fas fa-caret-down float-right "></i>
          </a>
              <ul class="sub-menu collapse" id="vehicle">
                 <li><a href="<?php echo URL.DS.FOLDER_ADMIN;?>/vehicle/all"><i class="fas fa-truck-moving  "></i> All Vehicles</a></li>
               <li><a href="<?php echo URL.DS.FOLDER_ADMIN;?>/vehicle/add/"><i class="fas fa-plus "></i> Add A New Vehicles</a></li>
            
                </ul>
        </li>
          
                      <li class="nav-item">
          <a class="nav-link" href="dashboard" data-toggle="collapse" data-target="#employee">
            <i class="fas fa-fw fa-users "></i>
            <span><?php echo _("Employees");?></span> 
            <i class="fas fa-caret-down float-right "></i>
          </a>
              <ul class="sub-menu collapse" id="employee">
                 <li><a href="<?php echo URL.DS.FOLDER_ADMIN."/employee/all";?>"><i class="fas fa-user "></i> <?php echo _("All Employees");?></a></li>
               <li><a href="<?php echo  URL.DS.FOLDER_ADMIN."/employee/add";?>"><i class="fas fa-plus "></i> <?php echo _("Add A New Employee");?> </a></li>
            
                </ul>
        </li>
                        <li class="nav-item">
          <a class="nav-link" href="dashboard" data-toggle="collapse" data-target="#account">
            <i class="fas fa-fw fa-user-circle "></i>
            <span>Accounts</span>
            <i class="fas fa-caret-down float-right "></i>
          </a>
              <ul class="sub-menu collapse" id="account">
                 <li><a href="<?php echo URL.DS.FOLDER_ADMIN."/account/all";?>"><i class="fas fa-user "></i> All Accounts</a></li>
               <li><a href="<?php echo URL.DS.FOLDER_ADMIN."/account/add";?>"><i class="fas fa-plus "></i> Add A New Account</a></li>
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright © 2018 Aljazarisoft.com</span>
            </div>
          </div>
        </footer>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="<?php echo URL ?>/account/profile/signout">Logout</a>
          </div>
        </div>
      </div>
    </div>
