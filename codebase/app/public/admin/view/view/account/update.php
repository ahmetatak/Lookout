...
<div class="card mb-3">
    <div class="card-header">
        ...
        <?php echo _("Updating The Account"); ?>
    </div>
    <div class="card-body">
        <form action="<?php echo URL . DS . FOLDER_ADMIN . "/account/update/" . (isset($this->data["account"][0]["account_id"]) ? $this->data["account"][0]["account_id"] : ''); ?>" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-5">
                    <input maxlength="20" value="<?php echo (isset($this->data["account"][0]["username"]) ? $this->data["account"][0]["username"] : '') ?>" id="username" name="username" type="text" placeholder="Please enter username" class="form-control input-md" required="">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-5">
                    <input value="<?php echo (isset($this->data["account"][0]["username"]) ? $this->data["account"][0]["fullname"] : '') ?>" id="fullname" name="fullname" type="text" placeholder="Please enter name and surname" class="form-control input-md" required="">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-5">
                    <input value="<?php echo (isset($this->data["account"][0]["username"]) ? $this->data["account"][0]["email"] : '') ?>" id="email" name="email" type="text" placeholder="Please enter email" class="form-control input-md" required="">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-5">
                    <select id="rank" name="rank" class="form-control">
                        ...
                        if (isset($this->data["account"][0]["rank"])) {
                            $position = "";
                            if ($this->data["account"][0]["rank"] == "admin")
                                $position = _("Admin");
                            else    if ($this->data["account"][0]["rank"] == "user")
                                $position = _("User");
                            else    if ($this->data["account"][0]["employee_position"] == "editor")
                                $position = _("Editor");

                            echo ' <option selected value="' . $this->data["account"][0]["rank"] . '">' . $position . '</option>';
                        }
            ...
            <div class="form-group row">
                <label class="col-md-4 col-form-label" for="active"><?php echo _("Company statu"); ?></label>
                <div class="col-md-5">
                    <select id="active" name="active" class="form-control">
                        <?php echo ' <option selected value="' . (isset($this->data["account"][0]["active"]) ? $this->data["account"][0]["active"] : '') . '">' . (isset($statu) ? $statu : '') . '</option>';     ?>
