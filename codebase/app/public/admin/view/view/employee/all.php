            ...
            foreach ($this->data["employees"] as $this->key => $this->value) {
              ...
              echo '     <tr>
                      ...
                      <th>' . (isset($this->value["employee_position"]) ? $this->value["employee_position"] : '') . '</th>
                        ...
                        <th><a href="' . URL . DS . FOLDER_ADMIN . '/employee/update/' . (isset($this->value["employee_id"]) ? $this->value["employee_id"] : '') . '/" class="btn btn-light btn-sm"><i class="fas fa-edit "></i></a> </th>
