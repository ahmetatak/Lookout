...
<div class="card mb-3">
    <div class="card-header">
        ...
        <?php echo _("Add A New Device"); ?>
    </div>
    <div class="card-body">
        <form action="<?php echo URL . DS . FOLDER_ADMIN . "/device/add/"; ?>" method="post">

            <!-- Company name | Text input-->
            <div class="form-group row">
                <label class="col-md-4 col-form-label" for="key"><?php echo _("Device Access Key "); ?></label>
                <div class="col-md-5">
                    <input id="key" name="key" type="text" placeholder="Please enter the a valid access Key" class="form-control input-md" required="">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-5">
                    <input id="serial" name="serial" type="text" placeholder="Please enter serial number of the device" class="form-control input-md" required="">
            ...
            <div class="form-group row">
                <label class="col-md-4 col-form-label" for="owner"><?php echo _("Serial Number "); ?></label>
                <div class="col-md-5">
